netcdf AmpleroFluxnet.1.4_flux {
dimensions:
	x = 1 ;
	y = 1 ;
...
variables:
	...
	float Rnet(time, y, x) ;
		Rnet:units = "W/m^2" ;
		Rnet:missing_value = -9999.f ;
		Rnet:long_name = "Net absorbed radiation" ;
		Rnet:CF_name = "surface_net_downward_radiative_flux" ;
	...
	float Rnet_qc(time, y, x) ;
		Rnet_qc:units = "-" ;
		Rnet_qc:missing_value = -9999.f ;
		Rnet_qc:long_name = "Rnet quality control flag" ;
		Rnet_qc:values = "As fluxdata.org qcOK: 1 - ok, 0 - ??" ;
	float elevation(y, x) ;
		elevation:units = "m" ;
...
// global attributes:
		:Production_time = "2012-09-27 11:34:54" ;
